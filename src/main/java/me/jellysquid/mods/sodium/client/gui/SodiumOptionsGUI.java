...
public class SodiumOptionsGUI extends GuiScreen {
    ...
    private void rebuildGUI() {
        ...
        this.undoButton = new FlatButtonWidget(new Dim2i(this.width - 211, this.height - 26, 65, 20), new TextComponentTranslation("neonium.options.buttons.undo").getFormattedText(), this::undoChanges);
        this.applyButton = new FlatButtonWidget(new Dim2i(this.width - 142, this.height - 26, 65, 20), new TextComponentTranslation("neonium.options.buttons.apply").getFormattedText(), this::applyChanges);
        ...
        this.donateButton = new FlatButtonWidget(new Dim2i(this.width - 128, 6, 100, 20), new TextComponentTranslation("neonium.options.buttons.donate").getFormattedText(), this::openDonationPage);
        this.hideDonateButton = new FlatButtonWidget(new Dim2i(this.width - 26, 6, 20, 20), "x", this::hideDonationButton);

        if (Neonium.options().notifications.hideDonationButton) {
    ...
    private void renderOptionTooltip(ControlElement<?> element) {
        ...
        if (impact != null) {
            tooltip.add(TextFormatting.GRAY + I18n.format("neonium.options.performance_impact_string", impact.toDisplayString()));
        }
