...
public class SodiumGameOptionPages {
    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.view_distance.tooltip"))
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.brightness.tooltip"))
                        .setControl(opt -> new SliderControl(opt, 0, 100, 1, ControlValueFormatter.brightness()))
                        .setBinding((opts, value) -> opts.gammaSetting = value * 0.01F, (opts) -> (int) (opts.gammaSetting / 0.01F))
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.clouds.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.clouds.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.gui_scale.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.fullscreen.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> {
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.v_sync.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> {
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.fps_limit.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.view_bobbing.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(AttackIndicator.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.attack_indicator.tooltip"))
    ...
    public static OptionPage quality() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(GraphicsMode.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.graphics_quality.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.clouds_quality.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.clouds_quality.tooltip"))
                        .setControl(option -> new CyclingControl<>(option, SodiumGameOptions.GraphicsQuality.class))
                        .setBinding((opts, value) -> opts.quality.cloudQuality = value, opts -> opts.quality.cloudQuality)
                        .setImpact(OptionImpact.LOW)
                        .build())
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.weather_quality.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.weather_quality.tooltip"))
                        .setControl(option -> new CyclingControl<>(option, SodiumGameOptions.GraphicsQuality.class))
                        .setBinding((opts, value) -> opts.quality.weatherQuality = value, opts -> opts.quality.weatherQuality)
                        .setImpact(OptionImpact.MEDIUM)
                        .build())
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.leaves_quality.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.leaves_quality.tooltip"))
                        .setControl(option -> new CyclingControl<>(option, SodiumGameOptions.GraphicsQuality.class))
                ...
                .add(OptionImpl.createBuilder(ParticleMode.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.particle_quality.tooltip"))
                ...
                .add(OptionImpl.createBuilder(SodiumGameOptions.LightingQuality.class, sodiumOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.smooth_lighting.tooltip"))
                ...
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.biome_blend.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.biome_blend.tooltip"))
                        .setControl(option -> new SliderControl(option, 0, 7, 1, ControlValueFormatter.quantityOrDisabled("neonium.options.biome_blend.value", "gui.none")))
                        .setBinding((opts, value) -> opts.quality.biomeBlendRadius = value, opts -> opts.quality.biomeBlendRadius)
                        .setImpact(OptionImpact.LOW)
                        .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                        .build())
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.entity_distance.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.entity_distance.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.entity_shadows.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.entityShadows = value, opts -> opts.entityShadows)
                        .setImpact(OptionImpact.LOW)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.vignette.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.vignette.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(new TextComponentTranslation("neonium.options.mipmap_levels.tooltip"))
        ...
        return new OptionPage(new TextComponentTranslation("neonium.options.pages.quality"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_chunk_multidraw.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_chunk_multidraw.tooltip"))
                        .setControl(TickBoxControl::new)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_vertex_objects.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_vertex_objects.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_block_face_culling.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_block_face_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_compact_vertex_format.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_compact_vertex_format.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_fog_occlusion.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_fog_occlusion.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.translucency_sorting.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.translucency_sorting.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_entity_culling.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_entity_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.use_particle_culling.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.use_particle_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.LOW)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.animate_only_visible_textures.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.animate_only_visible_textures.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.allow_direct_memory_access.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.allow_direct_memory_access.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.ignore_driver_blacklist.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.ignore_driver_blacklist.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        return new OptionPage(new TextComponentTranslation("neonium.options.pages.advanced"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.chunk_update_threads.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.chunk_update_threads.tooltip"))
                        .setControl(o -> new SliderControl(o, 0, Runtime.getRuntime().availableProcessors(), 1, ControlValueFormatter.quantityOrDisabled("neonium.options.threads.value", "neonium.options.default")))
                        .setImpact(OptionImpact.HIGH)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TextComponentTranslation("neonium.options.always_defer_chunk_updates.name"))
                        .setTooltip(new TextComponentTranslation("neonium.options.always_defer_chunk_updates.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
        ...
        return new OptionPage(new TextComponentTranslation("neonium.options.pages.performance"), ImmutableList.copyOf(groups));
    }
}