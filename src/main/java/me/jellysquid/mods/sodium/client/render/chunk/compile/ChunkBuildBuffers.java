...
public class ChunkBuildBuffers {
    ...
    public void init(ChunkRenderData.Builder renderData) {
        for (int i = 0; i < this.buffersByLayer.length; i++) {
            ...
            for (ModelQuadFacing facing : ModelQuadFacing.VALUES) {
                writers[facing.ordinal()] = new ChunkModelVertexTransformer(this.vertexType.createBufferWriter(this.buffersByLayer[i][facing.ordinal()], Neonium.isDirectMemoryAccessEnabled()), this.offset);
            }
